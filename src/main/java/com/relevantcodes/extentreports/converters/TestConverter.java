...
public class TestConverter extends LogSettings {
	...
	public void createTestList() {
		...
		if (body == null || body.size() == 0) {
			logger.log(Level.SEVERE, "The supplied file " + file.getAbsolutePath() + " is not a valid Extent file. " + "Parsing failed, tests from the supplied file will not be listed in the current report.");
