...
public class ExtentReports extends Report implements Serializable {
    ...
    // logger.log(Level.WARNING, "Unable to perform report configuration. The
    ...
    // */
    // @SuppressWarnings("rawtypes")
    // public void loadConfig(Class clazz, String basePackagePath, String
    // fileName) {
    // String fullPackagePath = clazz.getPackage().getName().replace(".",
    // File.separator) + File.separator + fileName;
    //
    // if (basePackagePath != null) {
    // fullPackagePath = clazz.getPackage().getName().replace(".",
    ...
    // if (url == null) {
    // logger.log(Level.WARNING, "Unable to perform report configuration. The
    // package or file " + fullPackagePath
    // + " was not found.");
    //
    // return;
    // }
