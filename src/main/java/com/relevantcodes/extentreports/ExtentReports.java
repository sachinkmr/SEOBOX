...
public class ExtentReports extends Report implements Serializable {
	...
	public void loadConfig(File configFile) {
		if (!configFile.exists()) {
			logger.log(Level.WARNING, "Unable to perform report configuration. The file " + configFile.getAbsolutePath()
					+ " was not found.");
	 ...
	 * 
	 * @param clazz
	 *            The class relative to which the configuration file will be
	 *            loaded
	 * 
	 * @param fileName
	 ...
	 * 
	 * <p>
	 * Example: Sonsider the following <code>clazz</code>,
	 * <code>basePackagePath</code> and <code>fileName</code>:
	 * 
	 * <ul>
	 * <li><code>clazz</code> :
	 * "com/relevantcodes/extentreports/ExtentReports.class"</li>
	 * <li><code>basePackagePath</code> : "resources"</li>
	 * <li><code>fileName</code> : "extent-config.xml"</li>
	 * </ul>
	 * 
	 * <p>
	 * The above inputs will build the final path as:
	 ...
	 *            The package that contains the configuration file. The
	 *            basePackagePath is relative to the <code>clazz</code>
	 * 
	 * @param fileName
	 *            Name of the file from the <code>clazz</code> package
	 */
	...
	public void loadConfig(Class clazz, String basePackagePath, String fileName) {
		...
		if (basePackagePath != null) {
			fullPackagePath = clazz.getPackage().getName().replace(".", File.separator) + File.separator
					+ basePackagePath + File.separator + fileName;
		}

		URL url = getClass().getClassLoader().getResource(fullPackagePath);

		if (url == null) {
			logger.log(Level.WARNING, "Unable to perform report configuration. The package or file " + fullPackagePath
					+ " was not found.");
	...
	/**
	 * <p>
	 * This method is deprecated and replace with an external configuration
	 * file. For more information, visit this link:
	 * http://extentreports.relevantcodes.com/java/version2/docs.html#configuration
	 * 
	 * @return HTMLReporter.Config object
	 */
	@Deprecated
	...
	/**
	 * Removes all child nodes in <code>testList</code> - a container for parent
	 * tests only. When <code>flush()</code> is called, it adds all parent tests
	 * to the report and child tests as nodes. This method makes sure no child
	 * tests are added as top-level nodes.
	 */
