...
public class ScreenshotHtml {
	public static String getSource(String imgPath) {
		return "<a href='" + imgPath + "' data-featherlight='image'><img class='report-img' " + "src='file:///" + imgPath + "' /></a>";
	}
	...
	public static String getBase64Source(String imgSrc) {
		return "<a href='" + imgSrc + "' data-featherlight='image'><img class='report-img' " + "src='" + imgSrc + "' /></a>";
	}
}
