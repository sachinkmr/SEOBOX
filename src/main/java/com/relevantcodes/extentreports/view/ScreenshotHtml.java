...
public class ScreenshotHtml {
	...
	return "<a href='" + imgPath + "' data-featherlight='image'><img class='report-img' " + "src='file:///"
		+ imgPath + "' /></a>";
    }
	...
	return "<a href='" + imgSrc + "' data-featherlight='image'><img class='report-img' " + "src='" + imgSrc
		+ "' /></a>";
    }
}
