...
class HttpConnection implements Closeable {
	...
	public synchronized InputStream getInputStream() {
		...
		try {
			...
			if ((contentEncoding != null && (contentEncoding.contains("gzip") || contentEncoding.contains("compress"))) || (contentType != null && (contentType.contains("gzip") || contentType.contains("compress")))) {
