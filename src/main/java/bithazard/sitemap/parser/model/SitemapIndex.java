...
/**
 * A sitemap index that contains links to actual sitemaps. Class is immutable.
 * 
 * @author Bithazard
 */
public final class SitemapIndex {
	 ...
	 * 
	 * @param loc
	 *            The loc (URL) of the sitemap index. Must not be null
	 */
	 ...
	 *            The loc (URL) of the sitemap index. Must not be null
	 * @param lastMod
	 *            The lastmod property (last modified date) of the sitemap index
	 */
