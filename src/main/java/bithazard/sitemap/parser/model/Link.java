...
/**
 * A link to (usually) alternative language versions of a URL. Class is
 * immutable.
 * 
 * @author Bithazard
...
public final class Link {
	 ...
	 * 
	 * @param rel
	 *            The rel attribute (relation) of the link. Usually 'alternate'
	 *            to indicate alternative versions of a document. Must not be
	 *            null
	 * @param lang
	 *            The lang attribute (language or language-locale code) of the
	 *            link. Must not be null
	 * @param href
	 *            The href attribute (URL) of the link. Must not be null
	 */
	 ...
	 * 
	 * @return the lang attribute (language or language-locale code) of the
	 *         link.
	 */
	 ...
	 * @return true if the fields href, lang and rel of the reference object
	 *         equal those of this object, false otherwise,
	 */
	@Override
