...
/**
 * An entry of a sitemap (either of type XML or TEXT) that contains all relevant
 * information of the entry. This can be only the URL (loc), in case of a TEXT
 * sitemap or further information in case of an XML sitemap. Class is immutable.
 * 
 * @author Bithazard
 */
public final class SitemapEntry {
	 ...
	 * 
	 * @param loc
	 *            The loc (URL) of the sitemap entry. Must not be null
	 */
	 ...
	 * 
	 * @param loc
	 *            The loc property (URL) of the sitemap entry. Must not be null
	 * @param lastMod
	 *            The lastmod property (last modified date) of the sitemap entry
	 * @param changeFreq
	 *            The changefreq property (change frequency) of the sitemap
	 *            entry
	 * @param priority
	 *            The priority property of the sitemap entry
	 */
	 ...
	 *            The lastmod property (last modified date) of the sitemap entry
	 * @param links
	 *            The link properties of the sitemap entry. This is an extension
	 *            by Google to indicate alternate languages versions of an entry
	 *            in a sitemap
	 * @param changeFreq
	 *            The changefreq property (change frequency) of the sitemap
	 *            entry
	 * @param priority
	 *            The priority property of the sitemap entry
	 * @see <a href="https://support.google.com/webmasters/answer/2620865">Use a
	 *      sitemap to indicate alternate language pages</a>
	 */
	...
	/**
	 * Enum containing all possible values for the change frequency of a sitemap
	 * entry.
	 */
	...
	/**
	 * Get the link properties of the sitemap entry. Can be null when the
	 * sitemap entry has no links.
	 * 
	...
	/**
	 * Get the lastmod property (last modified date) of the sitemap entry. Can
	 * be null when the sitemap entry has no lastmod property.
	 * 
	...
	/**
	 * Get the changefreq property (change frequency) of the sitemap entry. Can
	 * be null when the sitemap entry has no changefreq property.
	 * 
	...
	/**
	 * Get the priority property of the sitemap entry. Can be null when the
	 * sitemap entry has no priority property.
	 * 
	 ...
	 * @return true if the loc property of the reference object equals the loc
	 *         property of this object, false otherwise.
	 */
	@Override
