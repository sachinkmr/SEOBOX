...
public class SiteLevel {
	...
	try {
	    String add = HelperUtils.getSiteAddress(SEOConfig.site) + "robots.txt";
	    ...
	    test.log(LogStatus.PASS, "Robot.txt Location: </br>" + add, "");
	    Response response = HelperUtils.getLinkResponse(add, SEOConfig.user, SEOConfig.pass);
	...
	ExtentTest test = HelperUtils.getTestLogger(caller);
	try {
	    String add = HelperUtils.getSiteAddress(SEOConfig.site) + "sitemap.xml";
	    ...
	    test.log(LogStatus.PASS, "Sitemap Location: </br>" + add, "");
	    Response response = HelperUtils.getLinkResponse(add, SEOConfig.user, SEOConfig.pass);
	    HttpResponse res = response.returnResponse();
	    int code = res.getStatusLine().getStatusCode();
