...
public class SEOCrawler extends WebCrawler {
	...
	public boolean shouldVisit(Page referringPage, WebURL url) {
		...
		return !CrawlerConstants.SKIPPED_URLS.contains(url.getModifiedHost()) && (m.find() || CrawlerConstants.ASSETS_PATTERN.matcher(url.getURL()).find());
	}
	...
	public void visit(Page page) {
		...
		try {
			if (page.getWebURL().isInternalLink() && page.getStatusCode() == 200 && page.getContentType().contains("text/html")) {
