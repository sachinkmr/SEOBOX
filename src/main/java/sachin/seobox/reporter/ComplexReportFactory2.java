...
public class ComplexReportFactory2 {

	private static ExtentReports reporter;
	private static Map<Long, String> threadToExtentTestMap = new HashMap<>();
	private static Map<String, ExtentTest> nameToTestMap = new HashMap<>();
